...
RUN julia --project=/root/Notmuch -e 'using Pkg; println(pwd()); Pkg.activate("ElMail");Pkg.add(url="https://github.com/gkappler/SMTPClient.jl");Pkg.add(path=".");Pkg.instantiate();'
# specify default command
CMD ["/root/Notmuch/ElMail/bin/server"]
