...
# !!! Main.UserApp is configured as an alias for Main.ElMail and you might encounter it in some tests
using Main.ElMail, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "ElMail tests" begin
  @includetests ARGS
end
